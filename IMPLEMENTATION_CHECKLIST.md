...
- [x] Ticketing Service: reservation (15-min TTL), inventory lock, purchase initiation.
...
- [x] Admin/Internal APIs: settlements finalize endpoint, support moderation endpoints.
