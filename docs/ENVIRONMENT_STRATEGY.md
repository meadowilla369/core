...
- Service routing: `AUTH_SERVICE_BASE_URL`, `USER_SERVICE_BASE_URL`, `KYC_SERVICE_BASE_URL`, `EVENT_SERVICE_BASE_URL`, `TICKETING_SERVICE_BASE_URL`, `PAYMENT_ORCHESTRATOR_BASE_URL`, `MARKETPLACE_SERVICE_BASE_URL`, `CHECKIN_SERVICE_BASE_URL`, `REFUND_SERVICE_BASE_URL`
